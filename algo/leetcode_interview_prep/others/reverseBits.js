...
console.log(reverseBite(parseInt('00000010100101000001111010011100', 2))); //964176192 (00111001011110000010100101000000)
console.log(reverseBite(parseInt('11111111111111111111111111111101', 2))); //3221225471 (10111111111111111111111111111111)
