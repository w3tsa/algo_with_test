/* 
Given an array of all parts and required parts, create a function 
that will take both input: allParts and requiredParts, and return
...
if (import.meta.vitest) {
  ...
  describe.skip('#buildRobot', () => {
    it("should return ['Rosie', 'Bender']", () => {
      expect(buildRobot(availableParts, requiredParts1)).toEqual(['Rosie', 'Bender']);
    });
    it("should return ['Rosie', 'Bender']", () => {
